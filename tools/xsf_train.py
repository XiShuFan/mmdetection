...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs/retinanet/retinanet_r50_fpn_1x_coco.py', help='train config file path')
    parser.add_argument('--work-dir', default='./xsf_result', help='the dir to save logs and models')
